 ...
 */
public class NewReplicaOntologyWizard extends Wizard implements INewWizard {
    ...
    public NewReplicaOntologyWizard() {
...
//        setWindowTitle(Messages.NewOntologyWizard_1); 
    ...
    public static String getId() {
        return "de.fzi.replica.neonplugin.wizard.NewReplicaOntologyWizard"; //$NON-NLS-1$
    }
