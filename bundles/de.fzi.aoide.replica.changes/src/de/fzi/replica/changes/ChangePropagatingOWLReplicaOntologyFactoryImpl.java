...
public class ChangePropagatingOWLReplicaOntologyFactoryImpl 
		extends OWLReplicaOntologyFactoryImpl implements OWLReplicaOntologyFactory {
	
	static {
        supportedSchemes.add("replica+changemanaged");
	}
	...
	*/
	...
	public OWLOntology createOWLOntology(OWLOntologyID ontologyID, IRI documentIRI,
		...
		OWLOntology instance = new ChangePropagatingOWLReplicaOntologyImpl(manager, ontologyID);
