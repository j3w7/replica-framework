 ...
 */
public class OWLReplicaOntologyFragmentFactoryImpl implements OWLReplicaOntologyFactory {
...
//	private static OWLDataFactory dataFactory = new OWLDataFactoryImpl();
	...
	static {
        ...
        supportedSchemes.add("replica+fragment");
	}
	
	public OWLReplicaOntologyFragmentFactoryImpl() {
	...
	*/
	public OWLOntology createOWLOntology(OWLOntologyID ontologyID, IRI documentIRI,
		...
		OWLReplicaOntologyFragment instance = new OWLReplicaOntologyFragmentImpl(manager, ontologyID);
		handler.ontologyCreated(instance);
		handler.setOntologyFormat(instance, new OWLReplicaOntologyFragmentFormat());
		return instance;
	}
