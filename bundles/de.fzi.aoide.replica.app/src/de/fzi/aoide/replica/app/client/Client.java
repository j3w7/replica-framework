...
import de.fzi.aoide.replica.app.Application;
 ...
 * @version version 0.4, 28.09.2011
 * 
 */
public interface Client extends Application {
	 ...
	 * @throws AddException
	 */
	void addOWLOntology(OWLOntology ontology, Set<? extends Object> groups,
			OnOntologyAddedListener listener)
			throws AddException;
