...
import static de.fzi.aoide.replica.app.msg.Message.REQUEST_GROUPS;
import static de.fzi.aoide.replica.app.msg.Message.REQUEST_ADD;
import static de.fzi.aoide.replica.app.msg.Message.REQUEST_SOIDS;
import static de.fzi.aoide.replica.app.msg.Message.REQUEST_ONTOIDS_GROUP;
...
import de.fzi.aoide.replica.app.AbstractMasterSlaveConceptApplication;
...
import de.fzi.aoide.replica.app.client.ClientConnectionActivityStates.AddOntology;
import de.fzi.aoide.replica.app.client.ClientConnectionActivityStates.GetGroups;
import de.fzi.aoide.replica.app.client.ClientConnectionActivityStates.GetOntologyIDs;
import de.fzi.aoide.replica.app.msg.Message;
import de.fzi.aoide.replica.comm.Connection;
import de.fzi.aoide.replica.comm.Connection.ConnectionContext;
import de.fzi.aoide.replica.comm.Connection.ConnectionContext.ConnectionActivity;
import de.fzi.aoide.replica.comm.channel.OnSignalReceivedListener;
import de.fzi.aoide.replica.comm.channel.Signal;
import de.fzi.aoide.replica.comm.channel.SignalChannel;
import de.fzi.aoide.replica.comm.channel.SignalChannel.SendMessageException;
import de.fzi.aoide.replica.comm.channel.SignalChannelManager.AddChannelException;
import de.fzi.aoide.replica.comm.util.MessageCarrier;
import de.fzi.aoide.replica.comm.util.ObjectMapBuilder;
import de.fzi.aoide.replica.util.OWLOntologyToOWLReplicaOntologyCopier;
						...
						public byte[] getContent() {
							return MessageCarrier.create(
									ObjectMapBuilder.create().
										...
										add("groupsIDs", groups != null ? 
												groups : Collections.singleton("")).
