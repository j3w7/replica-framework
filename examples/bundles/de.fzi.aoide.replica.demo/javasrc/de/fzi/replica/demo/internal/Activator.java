...
package de.fzi.replica.demo.internal;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		// Run ruby script
		InputStream is0 = getClass().getResourceAsStream("/rubysrc/Demo.rb");
		JRubyEngineFactory jRubyEngineFactory = new JRubyEngineFactory();
		new ScriptRunner(jRubyEngineFactory).run(is0);
		// Run groovy script
		InputStream is1 = getClass().getResourceAsStream("/groovysrc/Demo.groovy");
