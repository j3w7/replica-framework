...
public class AllTestsChangemanagedFragment {

	public static Test suite() {
		// Set change management scheme
		AbstractOWLReplicaOntologyTestCase.setOntologyID(new OWLOntologyID(
				IRI.create("replica+changemanaged+fragment://mySharedOntology/")));
		
		TestSuite suite = new TestSuite(AllTestsChangemanagedFragment.class.getName());
		//$JUnit-BEGIN$
